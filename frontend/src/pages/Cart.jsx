...
const Cart = () => {
  ...
  return (
    <div className="mb-20">
      <h2 className="text-xl font-semibold ml-2 mt-3">Cart Items</h2>
      <div>
        {cart.length === 0 ? (
        ...
        <div className="fixed bottom-0 left-0 w-full bg-red-500 bg-opacity-55 h-16 px-2 font-bold flex items-center border-t-2 border-t-red-500 pt-1">
          ...
          <button
            ...
            className="text-white bg-blue-500 font-bold px-3 h-12 py-1 rounded-lg ml-10"
          >
            Place Order
          </button>
        </div>
