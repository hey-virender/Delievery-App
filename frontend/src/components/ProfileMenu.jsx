...
const ProfileMenu = () => {
  return (
    <div className="profile-menu font-semibold px-5 mt-3 flex flex-col gap-2">
      <div className="user-details flex gap-6 items-center">
        <div>
          <svg
      ...
      <div className="settings flex gap-6 items-center">
        <div>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
